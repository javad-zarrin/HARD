//
// Generated file, do not edit! Created by opp_msgc 4.5 from src/rd_message.msg.
//
...
const char *rdMessageDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        case 9: return opp_typename(typeid(strtype));
        case 10: return opp_typename(typeid(strtype));
        default: return NULL;
    };
}
