        ...
        case Release_Resources : {
           ...
           case Main_Reply : {
               if (lsmsg->getDestination() == (unsigned int) vnode_id) {
                 ...
                 // string name1 = "Test-"+ss.str()+ "-PRW2-" + hh.str()+".data";
                  string name2 = "Test-"+ss.str()+ "-PRW2" + hh.str()+".txt";
...
//emit(finishSD,num_in_msg );
   ...
   string name3 = "Test-"+ss.str()+ "-PRW2-Traffic" + hh.str()+".txt";
   ...
   ofstream txt_result_file (name3.c_str(),  ios::app|ios::ate);
    if (txt_result_file.is_open())
    {
        txt_result_file << number_of_resources<< ","<< vnode_id<< "," << num_rec_overlay_msg<< "," << overal_transcated_data_overlay<< "," <<  num_rec_discovery_msg << "," << overal_transcated_data_discovery << "," << num_rec_routing_msg << "," << num_rec_dis_routing_msg << endl ;
        txt_result_file.close();
    }
    else EV << "Unable to open file";
