...
unsigned int Signal::getValue2() const
{
    return value2_var;
}

void Signal::setValue2(unsigned int value2)
{
...
int SignalDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='v' && strcmp(fieldName, "value2")==0) return base+4;
...
std::string SignalDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return ulong2string(pp->getValue2());
        default: return "";
    }
}
...
bool SignalDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setValue2(string2ulong(value)); return true;
